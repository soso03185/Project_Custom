...
namespace ProjectCustom_StageData
{
    ...
    { 
        ...
        static string spreadSheetID = "1eOSS4B7IL9E6E35xRZb43jzH1wsMGOrNOc9KR2BcK4s"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("ProjectCustom_StageData"); 
            if (text != null)
            {
